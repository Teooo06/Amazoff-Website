...
<nav class="navbar navbar-dark bg-dark fixed-top">
    <div class="container-fluid">
        <a class="navbar-brand" href="riservato.jsp"><i class="fas fa-home"></i> Amazoff - Carrello</a>
        ...
        <div class="offcanvas offcanvas-end text-bg-dark" tabindex="-1" id="offcanvasDarkNavbar" aria-labelledby="offcanvasDarkNavbarLabel">
            ...
            <div class="offcanvas-body">
                <ul class="navbar-nav justify-content-end flex-grow-1 pe-3">
                    ...
                    <li class="nav-item" >
                        <a class="nav-link active" href="#" aria-disabled="false">Carrello</a>
                    </li>
                    <li class="nav-item" >
...
<div class="container d-flex justify-content-center align-items-center" style="min-height: 80vh;">
    <div class="card p-4" style="width: 60%;">
        <h3>Carrello di <%= userNameSession %></h3>
        <%ResultSet rs = null;%>
        ...
        <% } else if ("errore".equals(acquisto)) { %>
        ...
        <table class="table table-bordered table-rounded mt-3">
            ...
            <%
                ...
                try {
                    ...
                    String sql = "SELECT idProdotto, data, costo FROM carrello WHERE username = '" + userNameSession + "'";
                    rs = funzioni.select(sql);
        ...
        <!-- Bottone per comprare se ci sono prodotti nel carrello -->

        <% if (hasItems) { %>
        <!-- Bottone per comprare se ci sono prodotti nel carrello -->
        <a href="compra.jsp" class="btn btn-primary">Compra</a>
        <% } else { %>
        <!-- Bottone per reindirizzare al catalogo se il carrello è vuoto -->
        <a href="riservato.jsp" class="btn btn-secondary">Vai al catalogo</a>
        <% } %>
